/*------------------------------------------------------------------------------
    ...
    Location : $URL: svn://code.campware.org/campcaster/trunk/campcaster/src/modules/eventScheduler/include/LiveSupport/EventScheduler/EventContainerInterface.h $
