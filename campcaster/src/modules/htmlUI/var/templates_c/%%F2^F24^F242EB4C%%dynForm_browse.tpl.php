<?php /* Smarty version 2.6.6, created on 2007-12-21 23:20:22
         compiled from library/dynForm_browse.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'library/dynForm_browse.tpl', 34, false),)), $this); ?>
    ...
    <?php else: ?>
        <div class="container_browse">
            <?php if ($this->_tpl_vars['element']['label']): ?>
                <label for='category_1'><?php echo $this->_tpl_vars['element']['label']; ?>
...
?>
    ...
    <?php if ($this->_tpl_vars['dynform']['requirednote'] && ! $this->_tpl_vars['dynform']['frozen']): ?>
            <?php endif; ?>
</form>
