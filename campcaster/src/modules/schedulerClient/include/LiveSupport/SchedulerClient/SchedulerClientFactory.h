/*------------------------------------------------------------------------------
    ...
    Location : $URL: svn://code.campware.org/campcaster/trunk/campcaster/src/modules/schedulerClient/include/LiveSupport/SchedulerClient/SchedulerClientFactory.h $
