/*------------------------------------------------------------------------------
    ...
    Author   : $Author: ngrujic $
    Version  : $Revision: 3018 $
    Location : $URL: svn://code.campware.org/campcaster/branches/gstreamer-0.10/campcaster/src/modules/playlistExecutor/src/GstreamerPlayContext.h $
