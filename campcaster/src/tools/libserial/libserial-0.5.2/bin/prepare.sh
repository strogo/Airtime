...
#   Location : $URL: svn://code.campware.org/campcaster/trunk/campcaster/src/tools/libserial/libserial-0.5.2/bin/prepare.sh $
#-------------------------------------------------------------------------------                                                                                
#-------------------------------------------------------------------------------
# Run this script to prepare libserial to be configured and compiled.
# For more information on libserial, see http://libserial.sourceforge.net/
#-------------------------------------------------------------------------------
product=libserial-0.5.2
