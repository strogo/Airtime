...
#
#   Author   : $Author: mark $
#   Version  : $Revision: 3114 $
#   Location : $URL: svn://code.campware.org/campcaster/branches/gstreamer-0.10/campcaster/src/tools/gstreamer/gstreamer-0.10.15/bin/prepare.sh $
#-------------------------------------------------------------------------------                                                                                
#-------------------------------------------------------------------------------
