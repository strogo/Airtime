...
/*------------------------------------------------------------------------------
    ...
    Location : $URL: svn+ssh://csikosjanos@code.campware.org/home/svn/repo/livesupport/branches/ikra/src/modules/storageServer/var/audioClipFormat.php $

------------------------------------------------------------------------------*/

$tracklistFormat = array(
    '_root'=>'tracklist',
    'tracklist'=>array(
        'childs'=>array(
            'required'=>array('metadata'),
			'optional'=>array('tracklistItem'),
        ),
    ),
    'tracklistItem'=>array(
    	'childs'=>array(
    		'required'=>array('index','artist','title'),
    		'optional'=>array('featuring','remixer','album','label','year'),
    	),
    	'attrs'=>array(
    		'required'=>array('id'),
    	),
